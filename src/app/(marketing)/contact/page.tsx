      ...
      <div className="mx-auto max-w-content px-5 py-12 sm:px-8 sm:py-16">
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)] lg:gap-16">
          <div className="flex flex-col gap-6">
            <section className="flex flex-col gap-3 rounded-xl border border-line bg-paper-raised p-6">
              ...
              {hasAnyDirectContact() ? (
                ...
                <div className="flex flex-col gap-2 rounded-xl border border-line bg-paper-sunk p-5">
                  ...
                  <p className="text-small text-ink-muted">
                    ...
                    person and is the fastest way to reach us — you will hear
                    back within {slaHours} hours.
                  </p>
                </div>
              )}
            </section>
          ...
          <aside className="flex h-fit flex-col gap-5 rounded-xl border border-line bg-paper-raised p-6">
            ...
            <ol className="flex flex-col gap-3 text-small text-ink-muted">
              ...
              <li>
                ...
                Filling in a form does not subscribe you to anything. There is no
                drip campaign here to be added to.
              </li>
            </ol>
            <p className="border-t border-line pt-4 text-micro text-ink-subtle">
              ...
              say so and we will tell you honestly whether we can help. Read{" "}
              <Link
                href="/how-we-work"
